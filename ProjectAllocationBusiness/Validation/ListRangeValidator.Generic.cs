...
{
    public class ListRangeValidator<T> : ValueValidator<T>
        where T : IComparable
    {
        ...
        /// </summary>
        public ListRangeValidator(List<T> list)
            : this(list, false)
        { }
        ...
        /// <para>Initializes a new instance of the <see cref="NotNullValidator"/>.</para>
        /// </summary>
        public ListRangeValidator(List<T> list, bool negated)
        ...
        public ListRangeValidator(List<T> list, string messageTemplate)
        ...
        /// <param name="messageTemplate">The message template to log failures.</param>
        public ListRangeValidator(List<T> list, bool negated, string messageTemplate)
            : this(list, negated, messageTemplate, null)
        {
        }

        public ListRangeValidator(List<T> list, bool negated, string messageTemplate, string tag)
            ...
            ValidationResults validationResults)
        {
            ...
            logError = !isObjectToValidateNull && !this.IsInRange(objectToValidate);
        ...
        protected virtual bool IsInRange(T target)
        {
        ...
        protected override string DefaultNonNegatedMessageTemplate
        {
            get 
            { 
                return ProjectAllocationResource.Resource.ListRangeValidatorNonNegatedDefaultMessageTemplate; 
            }
        }
        ...
        protected override string DefaultNegatedMessageTemplate
        {
            get
            {
                return ProjectAllocationResource.Resource.ListRangeValidatorNegatedDefaultMessageTemplate; 
            }
        }
    }
}
