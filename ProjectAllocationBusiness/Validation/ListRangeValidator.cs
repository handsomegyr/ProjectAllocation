...
{
    public class ListRangeValidator : ListRangeValidator<string>
    {
        /// <summary>
        /// <para>Initializes a new instance of the <see cref="NotNullValidator"/>.</para>
        /// </summary>
        public ListRangeValidator(List<String> list)
            : this(list, false)
        { }
        ...
        /// <para>Initializes a new instance of the <see cref="NotNullValidator"/>.</para>
        /// </summary>
        public ListRangeValidator(List<String> list, bool negated)
        ...
        public ListRangeValidator(List<String> list, string messageTemplate)
        ...
        /// <param name="messageTemplate">The message template to log failures.</param>
        public ListRangeValidator(List<String> list, bool negated, string messageTemplate)
            : this(list, negated, messageTemplate, null)
        {
        }

        public ListRangeValidator(List<String> list, bool negated, string messageTemplate, string tag)
