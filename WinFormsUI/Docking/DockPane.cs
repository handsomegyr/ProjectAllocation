...
namespace WeifenLuo.WinFormsUI.Docking
{
	...
	public partial class DockPane : UserControl, IDockDragSource
	{
        ...
        {
            Console.WriteLine("dockPane.IsDockStateValid");
            return IsDockStateValid(dockState);
        }

        bool IDockDragSource.CanDockTo(DockPane pane)
        {
            Console.WriteLine("dockPane.CanDockTo");
        ...
        {
            Console.WriteLine("dockPane.BeginDrag");
        ...
        {
            Console.WriteLine("dockPane.FloatAt");
        ...
        {
            Console.WriteLine("dockPane.DockTo DockPane DockStyle" + dockStyle.ToString() + "contentIndex" + contentIndex.ToString());
        ...
        {
            Console.WriteLine("dockPane.DockTo DockPanel DockStyle" + dockStyle.ToString());
            if (panel != DockPanel)
