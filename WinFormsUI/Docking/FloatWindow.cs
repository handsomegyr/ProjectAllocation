	...
	public class FloatWindow : Form, INestedPanesContainer, IDockDragSource
	{
		...
		protected override void WndProc(ref Message m)
		{
			if (m.Msg == (int)Win32.Msgs.WM_NCLBUTTONDOWN)
			{
				...
				{
					Activate();
                    Console.WriteLine("FloatWindow:WndProc" + m.ToString());
		...
		{
            Console.WriteLine("FloatWindow:TestDrop");
        ...
        {
            Console.WriteLine("FloatWindow:IsDockStateValid");
            return IsDockStateValid(dockState);
        }

        bool IDockDragSource.CanDockTo(DockPane pane)
        {
            Console.WriteLine("FloatWindow:CanDockTo");
        ...
        {
            Console.WriteLine("FloatWindow:BeginDrag(Point ptMouse)");
            return Bounds;
        }

        public  void FloatAt(Rectangle floatWindowBounds)
        {
            Console.WriteLine("FloatWindow:FloatAt");
            Bounds = floatWindowBounds;
        }

        public void DockTo(DockPane pane, DockStyle dockStyle, int contentIndex)
        {
            Console.WriteLine("FloatWindow:DockTo(DockPane pane, DockStyle dockStyle, int contentIndex)");
        ...
        {
            Console.WriteLine("FloatWindow:DockTo(DockPanel panel, DockStyle dockStyle)");
            if (panel != DockPanel)
        ...
        {
            Console.WriteLine("FloatWindow:MergeNestedPanes");
